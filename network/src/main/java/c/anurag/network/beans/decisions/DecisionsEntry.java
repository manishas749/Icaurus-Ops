...
public class DecisionsEntry implements IEntry<DecisionsResponse> {

    private final String tableName;
    private final IcarusDatabaseManager icarusDatabaseManager;

    public DecisionsEntry(String tableName, IcarusDatabaseManager icarusDatabaseManager) {
        this.tableName = tableName;
        this.icarusDatabaseManager = icarusDatabaseManager;
    }

    @Override
    public DecisionsResponse insertUpdate(DecisionsResponse response) {
        List<Decisions> data = response.getData();
        String insertSql = "INSERT INTO " + tableName + " (id, uuid, description, created, " +
                "modified) VALUES (?,?,?,?,?);";
    ...
    private void bulkInsertUpdate(SQLiteStatement statement, Decisions obj, boolean insert) {
