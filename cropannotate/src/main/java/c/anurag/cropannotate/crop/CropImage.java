...
public final class CropImage {
     ...
     * specific request.
     */
    public static final int CLICK_IMAGE_CAMERA_REQUEST_CODE = 501;

    /**
     * The request code used to start pick image activity to be used on result to identify the this
     * specific request.
     */
    public static final int PICK_IMAGE_CHOOSER_REQUEST_CODE = 502;
     ...
     */
    private static void selectImage(final Activity context, final Uri photoPath) {

        final ArrayList<String> items = new ArrayList<>();
        items.add(context.getString(R.string.camera));
        items.add(context.getString(R.string.gallery));
        items.add(context.getString(R.string.cancel));
        ...
        builder.setItems(items.toArray(new String[items.size()]), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int position) {
                ...
                if (mImageTaskSelected.equals(context.getString(R.string.camera))) {
                    dialog.dismiss();
                    context.startActivityForResult(
                            getCameraIntent(context, photoPath), CLICK_IMAGE_CAMERA_REQUEST_CODE);
                } else if (mImageTaskSelected.equals(context.getString(R.string.gallery))) {
                    context.startActivityForResult(Intent.createChooser(getPickImageChooserIntent(context),
                            "Select Picture"), PICK_IMAGE_CHOOSER_REQUEST_CODE);
                    dialog.dismiss();
                } else if (mImageTaskSelected.equals(context.getString(R.string.cancel))) {
                    dialog.dismiss();
                }
            }
        });
     ...
     */
    public static void startPickImageActivity(@NonNull Activity activity, Uri photoPath) {
        selectImage(activity, photoPath);
    }
     ...
     */
    public static void startPickImageActivity(@NonNull Context context, @NonNull Fragment fragment, Uri photoUri) {
        fragment.startActivityForResult(
                getPickImageChooserIntent(context, photoUri), PICK_IMAGE_CHOOSER_REQUEST_CODE);
    }
     ...
     */
    public static Intent getPickImageChooserIntent(@NonNull Context context, Uri photoPath) {
