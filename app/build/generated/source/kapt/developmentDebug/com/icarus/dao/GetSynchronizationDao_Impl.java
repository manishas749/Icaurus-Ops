...
public final class GetSynchronizationDao_Impl extends GetSynchronizationDao {
  ...
  public void insertChecklistLocationList(
      final List<ChecklistLocationEntity> checklistLocationEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertAssignedChecklistsList(
      final List<AssignCheckListEntity> assignCheckListEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public void insertAssignedLogoEntityList(final List<AssignedLogoEntity> assignedLogoEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertAssignedRoomEquipmentEntityList(
      final List<AssignRoomEquipmentsEntity> assignRoomEquipmentsEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertAssignedDepartmentList(
      final List<AsssignedDepartmentsEntity> asssignedDepartmentsEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public void insertAssignedUsersList(final List<AssignedUserEntity> assignedUserEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
