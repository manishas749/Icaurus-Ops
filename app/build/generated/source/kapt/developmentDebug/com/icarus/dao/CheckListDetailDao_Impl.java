  ...
  public DataSource.Factory<Integer, ChecklistElementItem> getCheckListDetail(
    ...
    return new DataSource.Factory<Integer, ChecklistElementItem>() {
      ...
      public LimitOffsetDataSource<ChecklistElementItem> create() {
        return new LimitOffsetDataSource<ChecklistElementItem>(__db, _statement, false, true , "logs", "checklist_elements", "assigned_steps", "assigned_decisions", "assigned_ncw", "checklist_ppes", "ppes", "ncw_hazards", "hazards") {
          @Override
          protected List<ChecklistElementItem> convertRows(Cursor cursor) {
            final int _cursorIndexOfElementId = 0;
            final int _cursorIndexOfParentId = 1;
            ...
            final int _cursorIndexOfRootId = 13;
            final int _cursorIndexOfLevel = 14;
            final int _cursorIndexOfTotalParents = 15;
            final int _cursorIndexOfTotalExecutedParents = 16;
            final int _cursorIndexOfHasStepParent = 17;
            ...
            while(cursor.moveToNext()) {
              ...
              if (cursor.isNull(_cursorIndexOfItemUuid)) {
                _tmpItemUuid = null;
              } else {
              ...
              if (cursor.isNull(_cursorIndexOfPpesIcon)) {
                _tmpPpesIcon = null;
              } else {
              ...
              if (cursor.isNull(_cursorIndexOfHazardsIcon)) {
  ...
  public DataSource.Factory<Integer, ChecklistDetailItems> getChecklistIncompleteElements(
    ...
    return new DataSource.Factory<Integer, ChecklistDetailItems>() {
      ...
      public LimitOffsetDataSource<ChecklistDetailItems> create() {
        return new LimitOffsetDataSource<ChecklistDetailItems>(__db, _statement, false, true , "logs", "checklist_ppes", "ppes", "ncw_hazards", "hazards", "checklist_elements", "resources", "assigned_ncw", "assigned_steps", "assigned_decisions") {
          @Override
          protected List<ChecklistDetailItems> convertRows(Cursor cursor) {
            ...
            final int _cursorIndexOfParentType = 6;
            final int _cursorIndexOfParentStatus = 7;
            final int _cursorIndexOfSortOrder = 8;
            final int _cursorIndexOfSequenceNo = 9;
            final int _cursorIndexOfTitle = 10;
            final int _cursorIndexOfDescription = 11;
            final int _cursorIndexOfAcknowledged = 12;
            final int _cursorIndexOfStatus = 13;
            final int _cursorIndexOfDecisionStatus = 14;
            final int _cursorIndexOfImageTextStatus = 15;
            final int _cursorIndexOfPpesIcon = 16;
            final int _cursorIndexOfHazardsIcon = 17;
