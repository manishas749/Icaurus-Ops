  ...
  public DataSource.Factory<Integer, CancelledCompletedChecklistItems> getCheckListSortByDueDate(
    ...
    return new DataSource.Factory<Integer, CancelledCompletedChecklistItems>() {
      ...
      public LimitOffsetDataSource<CancelledCompletedChecklistItems> create() {
        return new LimitOffsetDataSource<CancelledCompletedChecklistItems>(__db, _statement, false, true , "assigned_checklists", "checklists", "checklist_titles", "assigned_users", "users", "assigned_room_equipments", "rooms", "equipments", "user_favorites") {
          @Override
          protected List<CancelledCompletedChecklistItems> convertRows(Cursor cursor) {
            ...
            final int _cursorIndexOfModified = 2;
            ...
            final int _cursorIndexOfSynced = 6;
            final int _cursorIndexOfMasterSyncStatus = 7;
            final int _cursorIndexOfLastUpdatedBy = 8;
            final int _cursorIndexOfPendingAssignedElementsCount = 9;
            final int _cursorIndexOfPendingAssignedResourcesCount = 10;
            final int _cursorIndexOfIsFavorite = 11;
            final int _cursorIndexOfChecklistType = 12;
            ...
            while(cursor.moveToNext()) {
              ...
              if (cursor.isNull(_cursorIndexOfLastUpdatedBy)) {
                _tmpLastUpdatedBy = null;
              } else {
      ...
      public LimitOffsetDataSource<CancelledCompletedChecklistItems> create() {
        return new LimitOffsetDataSource<CancelledCompletedChecklistItems>(__db, _statement, false, true , "assigned_checklists", "checklists", "checklist_titles", "assigned_users", "users", "assigned_room_equipments", "rooms", "equipments", "user_favorites") {
          ...
          protected List<CancelledCompletedChecklistItems> convertRows(Cursor cursor) {
            ...
            final int _cursorIndexOfModified = 2;
            final int _cursorIndexOfTitle = 3;
            final int _cursorIndexOfLastUpdatedBy = 4;
            final int _cursorIndexOfPendingResourcesCount = 5;
            final int _cursorIndexOfPendingReferencesCount = 6;
            final int _cursorIndexOfSynced = 7;
            final int _cursorIndexOfMasterSyncStatus = 8;
            final int _cursorIndexOfIsFavorite = 9;
            final int _cursorIndexOfPendingAssignedElementsCount = 10;
            final int _cursorIndexOfPendingAssignedResourcesCount = 11;
            final int _cursorIndexOfChecklistType = 12;
            final List<CancelledCompletedChecklistItems> _res = new ArrayList<CancelledCompletedChecklistItems>(cursor.getCount());
            while(cursor.moveToNext()) {
              final CancelledCompletedChecklistItems _item_2;
