...
public final class AllCheckListDao_Impl implements AllCheckListDao {
  ...
  public DataSource.Factory<Integer, AllChecklistItems> getAllCheckList(final Integer udid,
    ...
    return new DataSource.Factory<Integer, AllChecklistItems>() {
      ...
      public LimitOffsetDataSource<AllChecklistItems> create() {
        return new LimitOffsetDataSource<AllChecklistItems>(__db, _statement, false, true , "checklists", "checklist_titles", "checklist_statuses", "checklist_types", "checklist_locations", "departments", "user_location_departments", "checklist_execution_permissions", "user_favorites") {
          @Override
          protected List<AllChecklistItems> convertRows(Cursor cursor) {
            ...
            final int _cursorIndexOfSyncStatus = 5;
            final int _cursorIndexOfChecklistTypeId = 6;
            final int _cursorIndexOfDepartmentId = 7;
            final int _cursorIndexOfDepartmentName = 8;
            final int _cursorIndexOfIsSequential = 9;
            final int _cursorIndexOfIsApprovalRequired = 10;
            final int _cursorIndexOfChecklistStatusName = 11;
            final int _cursorIndexOfChecklistStatusIsExpired = 12;
            final int _cursorIndexOfIsAssignable = 13;
            final int _cursorIndexOfIsExecutable = 14;
            final int _cursorIndexOfDueAt = 15;
            final int _cursorIndexOfModified = 16;
            final int _cursorIndexOfIsFavorite = 17;
            final int _cursorIndexOfPlaceholderCount = 18;
            ...
            while(cursor.moveToNext()) {
              ...
              if (cursor.isNull(_cursorIndexOfDepartmentName)) {
                _tmpDepartmentName = null;
              } else {
              ...
              if (cursor.isNull(_cursorIndexOfChecklistStatusName)) {
                _tmpChecklistStatusName = null;
              } else {
  ...
  public DataSource.Factory<Integer, AllChecklistItems> getAllCheckListAdmin(final Integer udid,
    ...
    return new DataSource.Factory<Integer, AllChecklistItems>() {
      @Override
      public LimitOffsetDataSource<AllChecklistItems> create() {
        return new LimitOffsetDataSource<AllChecklistItems>(__db, _statement, false, true , "checklists", "checklist_titles", "checklist_statuses", "checklist_types", "checklist_locations", "departments", "checklist_execution_permissions", "user_favorites") {
          @Override
          protected List<AllChecklistItems> convertRows(Cursor cursor) {
            final int _cursorIndexOfChecklistId = 0;
            final int _cursorIndexOfUuid = 1;
            final int _cursorIndexOfTitle = 2;
            final int _cursorIndexOfChecklistTypeId = 3;
            final int _cursorIndexOfPendingResourcesCount = 4;
            final int _cursorIndexOfPendingReferencesCount = 5;
            final int _cursorIndexOfSyncStatus = 6;
            final int _cursorIndexOfDepartmentId = 7;
            final int _cursorIndexOfDepartmentName = 8;
            final int _cursorIndexOfIsSequential = 9;
            final int _cursorIndexOfIsApprovalRequired = 10;
  ...
  public List<StringCheckBox> getDepartmentFilterList(final Integer locationId) {
    ...
    try {
      ...
      final int _cursorIndexOfShortName = 2;
  ...
  public List<RoomAssetItems> getRoomAssets(final Integer checklistId, final Integer locationId) {
    ...
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
      final int _cursorIndexOfRoomId = 0;
      final int _cursorIndexOfEquipmentId = 1;
      final int _cursorIndexOfRoom = 2;
      final int _cursorIndexOfAsset = 3;
      final int _cursorIndexOfRoomAsset = 4;
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfRoomAsset)) {
          _item.roomAsset = null;
        } else {
