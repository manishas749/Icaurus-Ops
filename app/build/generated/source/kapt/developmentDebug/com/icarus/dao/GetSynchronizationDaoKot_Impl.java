...
public final class GetSynchronizationDaoKot_Impl implements GetSynchronizationDaoKot {
  ...
  public GetSynchronizationDaoKot_Impl(RoomDatabase __db) {
    this.__db = __db;
    ...
    this.__insertionAdapterOfLocationEquipmentsEntity = new EntityInsertionAdapter<LocationEquipmentsEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, LocationEquipmentsEntity value) {
        ...
        final Integer _tmp = value.getIsDeleted() == null ? null : (value.getIsDeleted() ? 1 : 0);
        if (_tmp == null) {
          stmt.bindNull(5);
        } else {
  ...
  @Override
  public Object insertItemType(final ItemTypeEntity itemTypeEntity,
  ...
  public void insertLocationRoomEquipments(
      final List<? extends LocationRoomEquipmentsEntity> locationRoomEquipmentsEntity) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertLocationDepartments(
      final List<? extends LocationDepartmentsEntity> locationDepartmentsEntity) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public void insertChecklistLocationList(
      final List<? extends ChecklistLocationEntity> checklistLocationEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfChecklistLocationEntity.insert(checklistLocationEntityList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void insertAssignedChecklistsList(
      final List<? extends AssignCheckListEntity> assignCheckListEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfAssignCheckListEntity.insert(assignCheckListEntityList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void insertAssignedLogoEntityList(
      final List<? extends AssignedLogoEntity> assignedLogoEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfAssignedLogoEntity.insert(assignedLogoEntityList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void insertAssignedRoomEquipmentEntityList(
      final List<? extends AssignRoomEquipmentsEntity> assignRoomEquipmentsEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfAssignRoomEquipmentsEntity.insert(assignRoomEquipmentsEntityList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void insertAssignedDepartmentList(
      final List<? extends AsssignedDepartmentsEntity> asssignedDepartmentsEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfAsssignedDepartmentsEntity.insert(asssignedDepartmentsEntityList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void insertAssignedUsersList(
      final List<? extends AssignedUserEntity> assignedUserEntityList) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfAssignedUserEntity.insert(assignedUserEntityList);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public void insertChecklistLogo(final List<? extends CheckListLogoEntity> mapChecklistLogo) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertChecklistRoomEquipments(
      final List<? extends ChecklistRoomEquipmentsEntity> mapRoomEquipment) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public void insertWorkorderAttachment(
      final List<? extends WorkOrderAttachmentsEntity> workOrderAttachmentsEntity) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfWorkOrderAttachmentsEntity.insert(workOrderAttachmentsEntity);
  ...
  public void insertWorkOrderAttachments(
      final List<? extends WorkOrderAttachmentsEntity> workOrderAttachmentEntity) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public void insertWorkOrderNotes(
      final List<? extends WorkOrderNotesEntity> workOrderNotesEntity) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertWorkOrderNoteDetails(
      final List<? extends WorkOrderNoteDetailEntity> workOrderNoteDetailEntity) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  @Override
  public void updateWorkOrderNotes(
      final List<? extends WorkOrderNotesEntity> workOrderNotesEntities) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
  ...
  public void insertLocationsWithAssociatedData(
      final List<? extends LocationEntity> locationEntities,
      final List<? extends LocationDepartmentsEntity> locationDepartmentsEntities) {
    __db.beginTransaction();
    try {
      GetSynchronizationDaoKot.DefaultImpls.insertLocationsWithAssociatedData(GetSynchronizationDaoKot_Impl.this, locationEntities, locationDepartmentsEntities);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  public void insertChecklistAssociatedData(final AllChecklistEntity checklist,
      final CheckListTitlesEntity checklistTitle,
      final List<? extends CheckListLogoEntity> checklistLogos) {
    __db.beginTransaction();
    try {
      GetSynchronizationDaoKot.DefaultImpls.insertChecklistAssociatedData(GetSynchronizationDaoKot_Impl.this, checklist, checklistTitle, checklistLogos);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  public void saveWorkOrder(final WorkOrderEntity workOrderEntity,
      final List<? extends WorkOrderNotesEntity> workOrderNoteEntities,
      final List<? extends WorkOrderNoteDetailEntity> workOrderNoteDetailEntities,
      final List<? extends WorkOrderAttachmentsEntity> workOrderAttachmentEntities) {
    __db.beginTransaction();
    try {
      GetSynchronizationDaoKot.DefaultImpls.saveWorkOrder(GetSynchronizationDaoKot_Impl.this, workOrderEntity, workOrderNoteEntities, workOrderNoteDetailEntities, workOrderAttachmentEntities);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  public List<ResourceDownloadItems> getResourcesToDownload(final Integer userId) {
    ...
    try {
      ...
      final int _cursorIndexOfIsDeleted = 4;
      final int _cursorIndexOfIsResource = 5;
      final int _cursorIndexOfChecklistIds = 6;
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfChecklistIds)) {
          _item.checklistIds = null;
        } else {
  ...
  public AssignedItemPlaceholderEntity ifPlaceholderExists(final Integer id,
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        if (_cursor.isNull(_cursorIndexOfAssignedChecklistUuid)) {
          _tmpAssignedChecklistUuid = null;
        } else {
  ...
  public AssignedUserEntity ifAssignedUserExists(final String uuid, final Integer userId) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        if (_cursor.isNull(_cursorIndexOfAssignedCheklistUUID)) {
          _result.assignedCheklistUUID = null;
        } else {
