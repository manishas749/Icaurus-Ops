    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfAssignedCheklistUUID)) {
          _item.assignedCheklistUUID = null;
        } else {
  ...
  public List<AssignedCheckListPauseTimesEntity> getNonSyncedAssignedChecklistPauseTime() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfAssignedChecklistUuid)) {
          _item.assigned_checklist_uuid = null;
        } else {
  ...
  public List<UserSuggestionAttachmentsEntity> getNonSyncedUserSuggestionAttachments() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfUserSuggestionUuid)) {
          _tmpUser_suggestion_uuid = null;
        } else {
