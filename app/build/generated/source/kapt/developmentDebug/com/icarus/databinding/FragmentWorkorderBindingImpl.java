...
public class FragmentWorkorderBindingImpl extends FragmentWorkorderBinding implements com.icarus.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.emptyViewImage, 6);
        sViewsWithIds.put(R.id.emptyViewText2, 7);
    }
    // views
    @NonNull
    ...
    public FragmentWorkorderBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentWorkorderBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback38 = new com.icarus.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.fab.setOnClickListener(mCallback38);
        }
        if ((dirtyFlags & 0xeL) != 0) {
            // api target 1
