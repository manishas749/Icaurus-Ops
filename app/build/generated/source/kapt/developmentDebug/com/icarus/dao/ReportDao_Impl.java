...
public final class ReportDao_Impl implements ReportDao {
  ...
  public AssignedChecklistSummary getSummary(final String assignedChecklistUuid) {
    ...
    try {
      final int _cursorIndexOfStartedBy = 0;
      final int _cursorIndexOfStartedAt = 1;
      final int _cursorIndexOfAction = 2;
      final int _cursorIndexOfLastPerformedBy = 3;
      final int _cursorIndexOfLastPerformedAt = 4;
      final int _cursorIndexOfActionReason = 5;
      final int _cursorIndexOfClosedBy = 6;
      final int _cursorIndexOfClosedAt = 7;
      final int _cursorIndexOfDepartment = 8;
      final int _cursorIndexOfLocation = 9;
      final int _cursorIndexOfRoom = 10;
      final int _cursorIndexOfEquipment = 11;
      final AssignedChecklistSummary _result;
      if(_cursor.moveToFirst()) {
        _result = new AssignedChecklistSummary();
        final String _tmpStartedBy;
        if (_cursor.isNull(_cursorIndexOfStartedBy)) {
          _tmpStartedBy = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfLastPerformedBy)) {
          _tmpLastPerformedBy = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfLastPerformedAt)) {
          _tmpLastPerformedAt = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfActionReason)) {
          _tmpActionReason = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfClosedBy)) {
          _tmpClosedBy = null;
        } else {
  ...
  public List<AssignmentHistory> getAssignmentHistory(final String assignedChecklistUuid) {
    ...
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
      final int _cursorIndexOfPerformedAt = 0;
      final int _cursorIndexOfAction = 1;
      final int _cursorIndexOfAssignedBy = 2;
      final int _cursorIndexOfAssignedTo = 3;
  ...
  public List<PausedHistory> getPauseHistory(final String assignedChecklistUuid,
    ...
    try {
      ...
      final int _cursorIndexOfPausedBy = 1;
      final int _cursorIndexOfPausedAt = 2;
      final int _cursorIndexOfPauseReason = 3;
      final int _cursorIndexOfResumedAt = 4;
      final int _cursorIndexOfResumedBy = 5;
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfPausedBy)) {
          _tmpPausedBy = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfPauseReason)) {
          _tmpPauseReason = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfResumedAt)) {
          _tmpResumedAt = null;
        } else {
        ...
        if (_cursor.isNull(_cursorIndexOfResumedBy)) {
          _tmpResumedBy = null;
        } else {
  ...
  public List<LogsSummary> getLogsSummary(final String checklistUUID) {
    ...
    try {
      ...
      final int _cursorIndexOfItemDescription = 4;
      final int _cursorIndexOfCreated = 5;
      final int _cursorIndexOfChecklistElementId = 6;
      final int _cursorIndexOfStepAction = 7;
      final int _cursorIndexOfAssignedChecklistUUID = 8;
      final int _cursorIndexOfAssignedStepResourceUUID = 9;
      final int _cursorIndexOfFileName = 10;
      final int _cursorIndexOfDisplayFileName = 11;
      final int _cursorIndexOfType = 12;
      ...
      while(_cursor.moveToNext()) {
        ...
        if (_cursor.isNull(_cursorIndexOfAssignedStepResourceUUID)) {
          _tmpAssignedStepResourceUUID = null;
        } else {
