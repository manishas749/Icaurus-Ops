...
import com.icarus.dao.GetSynchronizationDaoKot;
import com.icarus.dao.GetSynchronizationDaoKot_Impl;
...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  private volatile GetSynchronizationDaoKot _getSynchronizationDaoKot;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(7) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _indicesWorkorders.add(new TableInfo.Index("index_workorders_id", true, Arrays.asList("id"), Arrays.asList("ASC")));
        ...
        _indicesWorkorderNotes.add(new TableInfo.Index("index_workorder_notes_id", true, Arrays.asList("id"), Arrays.asList("ASC")));
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(WorkOrderCommonDao.class, WorkOrderCommonDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(WorkOrderDetailDao.class, WorkOrderDetailDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(WorkOrderDao.class, WorkOrderDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(CreateWorkOrderDao.class, CreateWorkOrderDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(AllCheckListDao.class, AllCheckListDao_Impl.getRequiredConverters());
    ...
    _typeConvertersMap.put(MyAssignmentDao.class, MyAssignmentDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(DepartmentChecklistDao.class, DepartmentChecklistDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(CancelledCompletedDao.class, CancelledCompletedDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(CheckListDetailDao.class, CheckListDetailDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(UserSuggestionDao.class, UserSuggestionDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(AllCaptureDataDao.class, AllCaptureDataDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(GetSynchronizationDao.class, GetSynchronizationDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(GetSynchronizationDaoKot.class, GetSynchronizationDaoKot_Impl.getRequiredConverters());
    _typeConvertersMap.put(GetChecklistElementDao.class, GetChecklistElementDao_Impl.getRequiredConverters());
    ...
    _typeConvertersMap.put(PostSynchronizationDao.class, PostSynchronizationDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(QRStepAttributeExecutionDao.class, QRStepAttributeExecutionDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(DashboardDao.class, DashboardDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(ChecklistExecutionDao.class, ChecklistExecutionDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(LogsDao.class, LogsDao_Impl.getRequiredConverters());
    _typeConvertersMap.put(ChecklistUndoDao.class, ChecklistUndoDao_Impl.getRequiredConverters());
  ...
  @Override
  public GetSynchronizationDaoKot getSynchronizationDaoKot() {
    if (_getSynchronizationDaoKot != null) {
      return _getSynchronizationDaoKot;
    } else {
      synchronized(this) {
        if(_getSynchronizationDaoKot == null) {
          _getSynchronizationDaoKot = new GetSynchronizationDaoKot_Impl(this);
        }
        return _getSynchronizationDaoKot;
      }
    }
