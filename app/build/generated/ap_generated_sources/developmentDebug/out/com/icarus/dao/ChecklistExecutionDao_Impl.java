...
public final class ChecklistExecutionDao_Impl implements ChecklistExecutionDao {
  ...
  public ChecklistDetailItems getItem(final Integer currentSortOrder, final String checkListUuid) {
    ...
    try {
      ...
      final int _cursorIndexOfParentType = CursorUtil.getColumnIndexOrThrow(_cursor, "parent_type");
      ...
      final int _cursorIndexOfAcknowledged = CursorUtil.getColumnIndexOrThrow(_cursor, "acknowledged");
      final int _cursorIndexOfImageTextStatus = CursorUtil.getColumnIndexOrThrow(_cursor, "imageTextStatus");
      final int _cursorIndexOfParentStatus = CursorUtil.getColumnIndexOrThrow(_cursor, "parent_status");
  ...
  public ChecklistDetailItems getDefferedItem(final Integer currentSortOrder,
    ...
    try {
      ...
      final int _cursorIndexOfParentType = CursorUtil.getColumnIndexOrThrow(_cursor, "parent_type");
      final int _cursorIndexOfParentStatus = CursorUtil.getColumnIndexOrThrow(_cursor, "parent_status");
      final int _cursorIndexOfImageTextStatus_1 = CursorUtil.getColumnIndexOrThrow(_cursor, "imageTextStatus");
      final int _cursorIndexOfTitle = CursorUtil.getColumnIndexOrThrow(_cursor, "title");
      final int _cursorIndexOfDescription = CursorUtil.getColumnIndexOrThrow(_cursor, "description");
      final ChecklistDetailItems _result;
      if(_cursor.moveToFirst()) {
        ...
        _result.setParentStatus(_tmpParentStatus);
        final Integer _tmpImageTextStatus_1;
        if (_cursor.isNull(_cursorIndexOfImageTextStatus_1)) {
          _tmpImageTextStatus_1 = null;
        } else {
          _tmpImageTextStatus_1 = _cursor.getInt(_cursorIndexOfImageTextStatus_1);
        }
        _result.setImageTextStatus(_tmpImageTextStatus_1);
        final String _tmpTitle;
        _tmpTitle = _cursor.getString(_cursorIndexOfTitle);
        _result.setTitle(_tmpTitle);
        final String _tmpDescription;
  ...
  public List<CheckListStepAttributeItems> getStepElments(final String stepId,
    ...
    try {
      ...
      final int _cursorIndexOfSortOrder = CursorUtil.getColumnIndexOrThrow(_cursor, "sort_order");
      final int _cursorIndexOfStepAttributeCount = CursorUtil.getColumnIndexOrThrow(_cursor, "step_attribute_count");
      final int _cursorIndexOfUserRoles = CursorUtil.getColumnIndexOrThrow(_cursor, "user_roles");
      final int _cursorIndexOfCustomFieldId = CursorUtil.getColumnIndexOrThrow(_cursor, "custom_field_id");
      final int _cursorIndexOfStepId = CursorUtil.getColumnIndexOrThrow(_cursor, "step_id");
      final int _cursorIndexOfStepAttributeUuid = CursorUtil.getColumnIndexOrThrow(_cursor, "uuid");
      final int _cursorIndexOfDescription = CursorUtil.getColumnIndexOrThrow(_cursor, "description");
      final int _cursorIndexOfName = CursorUtil.getColumnIndexOrThrow(_cursor, "name");
      final int _cursorIndexOfAllowGallery = CursorUtil.getColumnIndexOrThrow(_cursor, "allow_gallery");
      final int _cursorIndexOfAllowedMediaTypes = CursorUtil.getColumnIndexOrThrow(_cursor, "allowed_media_types");
      final int _cursorIndexOfMultiple = CursorUtil.getColumnIndexOrThrow(_cursor, "multiple");
      final int _cursorIndexOfDefaultValue = CursorUtil.getColumnIndexOrThrow(_cursor, "default_value");
      final int _cursorIndexOfMaxLength = CursorUtil.getColumnIndexOrThrow(_cursor, "max_length");
      final int _cursorIndexOfMaxValue = CursorUtil.getColumnIndexOrThrow(_cursor, "max_value");
      final int _cursorIndexOfMinLength = CursorUtil.getColumnIndexOrThrow(_cursor, "min_length");
      final int _cursorIndexOfMinValue = CursorUtil.getColumnIndexOrThrow(_cursor, "min_value");
      final int _cursorIndexOfModel = CursorUtil.getColumnIndexOrThrow(_cursor, "model");
      final int _cursorIndexOfPossibleValues = CursorUtil.getColumnIndexOrThrow(_cursor, "possible_values");
      final int _cursorIndexOfAllowDescription = CursorUtil.getColumnIndexOrThrow(_cursor, "allow_description");
      final int _cursorIndexOfDisplayAs = CursorUtil.getColumnIndexOrThrow(_cursor, "display_as");
      final int _cursorIndexOfRequired = CursorUtil.getColumnIndexOrThrow(_cursor, "required");
      final int _cursorIndexOfType = CursorUtil.getColumnIndexOrThrow(_cursor, "type");
      final int _cursorIndexOfAttributeValue = CursorUtil.getColumnIndexOrThrow(_cursor, "value");
  ...
  public ChecklistIDetailtems getChecklistDetail(final String assignedChecklistUuid) {
    ...
    final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
    try {
      final int _cursorIndexOfChecklistId = CursorUtil.getColumnIndexOrThrow(_cursor, "id");
      final int _cursorIndexOfUuid = CursorUtil.getColumnIndexOrThrow(_cursor, "uuid");
      final int _cursorIndexOfStatus = CursorUtil.getColumnIndexOrThrow(_cursor, "status");
      final int _cursorIndexOfChecklistType = CursorUtil.getColumnIndexOrThrow(_cursor, "type");
      final int _cursorIndexOfIsSequential = CursorUtil.getColumnIndexOrThrow(_cursor, "is_sequential");
      final int _cursorIndexOfTitle = CursorUtil.getColumnIndexOrThrow(_cursor, "title");
      ...
      final int _cursorIndexOfDueDays = CursorUtil.getColumnIndexOrThrow(_cursor, "due_days");
      final int _cursorIndexOfChecklistStatus = CursorUtil.getColumnIndexOrThrow(_cursor, "checklistStatus");
  ...
  public DataSource.Factory<Integer, CaptureDataItem> getAllCapturedData(
    ...
    return new DataSource.Factory<Integer, CaptureDataItem>() {
      ...
      public LimitOffsetDataSource<CaptureDataItem> create() {
        return new LimitOffsetDataSource<CaptureDataItem>(__db, _statement, false , "assigned_step_attributes", "checklist_elements", "step_attributes", "custom_fields") {
          @Override
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"logs","assigned_item_placeholders","item_placeholders","assigned_step_attributes","location_equipments","qr_storage"}, false, new Callable<List<QRAttributeScanItem>>() {
      ...
      public List<QRAttributeScanItem> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfChecklistElementId = CursorUtil.getColumnIndexOrThrow(_cursor, "checklist_element_id");
          final int _cursorIndexOfAssignedChecklistUuid = CursorUtil.getColumnIndexOrThrow(_cursor, "assigned_checklist_uuid");
          final int _cursorIndexOfEntityUuid = CursorUtil.getColumnIndexOrThrow(_cursor, "entity_uuid");
          final int _cursorIndexOfEntityName = CursorUtil.getColumnIndexOrThrow(_cursor, "entity_name");
          final int _cursorIndexOfModel = CursorUtil.getColumnIndexOrThrow(_cursor, "model");
          final int _cursorIndexOfVerificationReason = CursorUtil.getColumnIndexOrThrow(_cursor, "verification_reason");
          final int _cursorIndexOfUpcNumber = CursorUtil.getColumnIndexOrThrow(_cursor, "upc_number");
          final int _cursorIndexOfQrCode = CursorUtil.getColumnIndexOrThrow(_cursor, "qr_code");
