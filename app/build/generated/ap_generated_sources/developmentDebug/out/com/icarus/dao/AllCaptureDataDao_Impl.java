...
public final class AllCaptureDataDao_Impl implements AllCaptureDataDao {
  ...
  public DataSource.Factory<Integer, ElementWithCaptureDataItems> getElementsWithAttributes(
    ...
    return new DataSource.Factory<Integer, ElementWithCaptureDataItems>() {
      ...
      public LimitOffsetDataSource<ElementWithCaptureDataItems> create() {
        return new LimitOffsetDataSource<ElementWithCaptureDataItems>(__db, _statement, false , "checklist_elements", "assigned_steps", "step_attributes", "logs") {
          @Override
          protected List<ElementWithCaptureDataItems> convertRows(Cursor cursor) {
            final int _cursorIndexOfChecklistElementId = CursorUtil.getColumnIndexOrThrow(cursor, "checklist_element_id");
            ...
            final int _cursorIndexOfDescription_1 = CursorUtil.getColumnIndexOrThrow(cursor, "description");
            final int _cursorIndexOfStatus = CursorUtil.getColumnIndexOrThrow(cursor, "status");
            final int _cursorIndexOfAttributesCount = CursorUtil.getColumnIndexOrThrow(cursor, "attributes_count");
            ...
            while(cursor.moveToNext()) {
              ...
              final String _tmpDescription_1;
              _tmpDescription_1 = cursor.getString(_cursorIndexOfDescription_1);
              _item.setDescription(_tmpDescription_1);
  ...
  public List<ElementAttributesItems> getAttributes(final String assignedChecklistUUID,
    ...
    try {
      ...
      final int _cursorIndexOfCapturedUUID = CursorUtil.getColumnIndexOrThrow(_cursor, "captured_uuid");
      final int _cursorIndexOfCapturedValue = CursorUtil.getColumnIndexOrThrow(_cursor, "captured_value");
      final int _cursorIndexOfCapturedFile = CursorUtil.getColumnIndexOrThrow(_cursor, "captured_file");
