...
public final class DepartmentChecklistDao_Impl implements DepartmentChecklistDao {
  ...
  public DataSource.Factory<Integer, DepartmentChecklistItems> getAssignedDepartmentChecklistsOrderByLatestDue(
    ...
    return new DataSource.Factory<Integer, DepartmentChecklistItems>() {
      ...
      public LimitOffsetDataSource<DepartmentChecklistItems> create() {
        return new LimitOffsetDataSource<DepartmentChecklistItems>(__db, _statement, false , "assigned_checklists", "checklists", "checklist_titles", "checklist_types", "users", "assigned_room_equipments", "rooms", "equipments", "assigned_departments", "user_favorites", "departments", "user_location_departments") {
          @Override
  ...
  public DataSource.Factory<Integer, DepartmentChecklistItems> getAssignedDepartmentChecklistsOrderByLatestDueAdmin(
    ...
    return new DataSource.Factory<Integer, DepartmentChecklistItems>() {
      @Override
      public LimitOffsetDataSource<DepartmentChecklistItems> create() {
        return new LimitOffsetDataSource<DepartmentChecklistItems>(__db, _statement, false , "assigned_checklists", "checklists", "checklist_titles", "checklist_types", "users", "assigned_room_equipments", "rooms", "equipments", "assigned_departments", "user_favorites", "departments", "location_departments") {
          @Override
          protected List<DepartmentChecklistItems> convertRows(Cursor cursor) {
            final int _cursorIndexOfChecklistId = CursorUtil.getColumnIndexOrThrow(cursor, "id");
            final int _cursorIndexOfMasterSyncStatus = CursorUtil.getColumnIndexOrThrow(cursor, "sync_status");
