  ...
  public DataSource.Factory<Integer, WorkOrderItems> getWorkOrder(final Integer locationId,
    ...
    return new DataSource.Factory<Integer, WorkOrderItems>() {
      ...
      public LimitOffsetDataSource<WorkOrderItems> create() {
        return new LimitOffsetDataSource<WorkOrderItems>(__db, _statement, false , "workorders", "workorder_statuses", "departments", "users") {
          @Override
          protected List<WorkOrderItems> convertRows(Cursor cursor) {
            final int _cursorIndexOfWorkorderId = CursorUtil.getColumnIndexOrThrow(cursor, "id");
            ...
            final int _cursorIndexOfWorkorderPriorityId = CursorUtil.getColumnIndexOrThrow(cursor, "workorder_priority_id");
            final int _cursorIndexOfDueDays = CursorUtil.getColumnIndexOrThrow(cursor, "dueDays");
            final int _cursorIndexOfWorkorderStatusId = CursorUtil.getColumnIndexOrThrow(cursor, "workorder_status_id");
            final int _cursorIndexOfStatus = CursorUtil.getColumnIndexOrThrow(cursor, "status");
            final int _cursorIndexOfAssignedToType = CursorUtil.getColumnIndexOrThrow(cursor, "assigned_to_type");
            final int _cursorIndexOfAssignedToId = CursorUtil.getColumnIndexOrThrow(cursor, "assigned_to_id");
            final int _cursorIndexOfAssignee = CursorUtil.getColumnIndexOrThrow(cursor, "assignee");
            final int _cursorIndexOfDueDate = CursorUtil.getColumnIndexOrThrow(cursor, "due_date");
